...
const charmander = new Charmander("charmander.png", fuego, 40, 40, 30, 30, 20, 20, 1, "charmander")
const bulbasaur = new Bulbasaur("bulbasaurRiv.png", planta, 60, 60, 20, 20, 25, 25, 1, "bulbasaur")
const squirtle = new Squirtle("squirtleRiv.png", agua, 45, 45, 25, 25, 30, 30, 1, "squirtle")

const charmeleon = new Charmeleon("charmeleon.png", fuego, 100, 100, 120, 120, 100, 100, 2, "charmeleon")
const ivysaur = new Ivysaur("ivysaurRiv.png", planta, 150, 150, 100, 100, 110, 110, 2, "ivysaur")
const wartortle = new Wartortle("wartortleRiv.png", agua, 130, 130, 90, 90, 120, 120, 2, "wartortle")

const charizard = new Charizard("charizard.png", fuego, 300, 300, 150, 150, 120, 120, 3, "charizard")
const venasaur = new Venasaur("venusaurRiv.png", planta, 500, 500, 130, 130, 170, 170, 3, "venasaur")
const blastoise = new Blastoise("blastoiseRiv.png", agua, 200, 200, 100, 100, 150, 150, 3, "blastoise")

const megaCharizard = new MegaCharizard("charizard.png", fuego, 500, 500, 200, 200, 150, 150, 4, "megaCharizard")
const mewtwo = new Mewtwo("mewtwo.png", psiquico, 500, 500, 200, 200, 150, 150, 4, "mewtwo")
